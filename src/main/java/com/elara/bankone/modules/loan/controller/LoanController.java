package com.elara.bankone.modules.loan.controller;

import com.elara.bankone.modules.loan.dto.request.*;
import com.elara.bankone.modules.loan.dto.response.*;
import com.elara.bankone.modules.loan.service.LoanService;
...
public class LoanController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = {@Content(mediaType = "application/json",
                            schema = @Schema(implementation = LoansResponse.class))})})
    @GetMapping("/getDelinquentLoans")
    public LoansResponse getDelinquentLoans(DelinquentLoansRequest request)
            throws InvocationTargetException, IllegalAccessException
    {
